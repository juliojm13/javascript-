let app = {
    ...
    //  */
    insertPawns() {
        // (Done)6. получаем все теги td из 7 линии игрового поля, туда мы будем вставлять белые пешки
     ...
     */
    insertFiguresOnDesk() {
        // (Done) 5. в цикле перебираем массив positions
    ...
    getFigure(name, colorClass) {
        //(Done) 4. возвращаем в виде строки html-разметку фигуры, пример фигуры смотрите здесь https://fontawesome.com/icons/chess-rook?style=solid
     ...
     */
    generateBoard() {
        // (Done)3. создаем переменную board и присваиваем ей пустую строку, в ней будет храниться разметка игрового поля в виде строки
        let board = '';
    ...
    generateRow(startWithColor, rowNum) {
        // 2. создаем переменную currentColorClass, в которую пишем startWithColor(Done)
    ...
    generateField(color, rowNum, colChar) {
        // 1. вставьте нужные значения в атрибуты(done)
